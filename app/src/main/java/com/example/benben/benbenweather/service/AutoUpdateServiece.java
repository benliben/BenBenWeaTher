package com.example.benben.benbenweather.service;
 ...
 * 自动更新服务
 */
public class AutoUpdateServiece extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Intent i = new Intent(this, AutoUpdateServiece.class);
    ...
    private void updateWeather() {
        ...
        HttpUtil.sendHttpRequest(address, new HttpCallbackListener() {
            ...
            public void onFinish(String response) {
                Utility.handleWeatherResponse(AutoUpdateServiece.this, response);
            }
